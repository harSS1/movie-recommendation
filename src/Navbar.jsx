...
const Navbar = () => {
    ...
    return (
        <header className='flex justify-between items-center text-white py-4 px-9 md:px-32 bg-indigo-950 drop-shadow-md'>
            ...
            <div className="block xl:hidden">
                ...
                <div className={`absolute xl:hidden top-22 left-0 w-full bg-indigo-950 flex flex-col items-center gap-6 font-semibold text-lg transform transition-transform ${isMenuOpen ? 'opacity-100' : 'opacity-0'}`} style={{ transition: 'transform 0.3s ease, opacity 0.3s ease' }}>
